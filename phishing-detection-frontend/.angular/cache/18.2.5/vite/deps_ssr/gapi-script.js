...
(function() {
  ...
  fa("Symbol.iterator", function(a2) {
    ...
    for (var b2 = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), c = 0; c < b2.length; c++) {
      var d = ea[b2[c]];
      "function" === typeof d && "function" != typeof d.prototype[a2] && aa(d.prototype, a2, {
        configurable: true,
        writable: true,
        value: function() {
          return ia(ha(this));
  ...
  var H = function(a2, b2, c) {
    ...
    return c;
  }, Za = new RegExp(/^/.source + /([a-zA-Z][-+.a-zA-Z0-9]*:)?/.source + /(\/\/[^\/?#]*)?/.source + /([^?#]*)?/.source + /(\?([^#]*))?/.source + /(#((#|[^#])*))?/.source + /$/.source), $a = /[\ud800-\udbff][\udc00-\udfff]|[^!-~]/g, ab = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source, "g"), bb = /%([a-f]|[0-9a-fA-F][a-f])/g, cb = /^(https?|ftp|file|chrome-extension):$/i, I = function(a2) {
    a2 = String(a2);
  ...
  var Qb = decodeURI("%73cript"), Rb = /^[-+_0-9\/A-Za-z]+={0,2}$/, Sb = function(a2, b2) {
    ...
    if (e["::"] && b2.length) {
      ...
      for (; b2 = a2.shift(); ) $b(b2.V, c, b2.hint);
    } else $b(b2 || [], c, d);
  }, $b = function(a2, b2, c) {
    a2 = Pa(a2) || [];
  ...
  var zc, S, T = void 0, U = function(a2) {
    ...
    if ("undefined" !== d) {
      ...
      b2 = [];
      var e = V(a2);
      if (null != a2 && "function" === typeof a2.toJSON && (Object.prototype.hasOwnProperty.call(a2, "toJSON") || (e !== Fc || a2.constructor !== Array && a2.constructor !== Object) && (e !== Ec || a2.constructor !== Array && a2.constructor !== Object) && e !== Dc && e !== Ac && e !== Cc && e !== Bc)) return W(a2.toJSON.call(a2), c);
      if (null == a2) b2[b2.length] = "null";
        ...
        if (e === Fc && V(a2.length) === Ac) {
          ...
          b2[b2.length] = "{";
          d = 0;
          for (f in a2) Object.prototype.hasOwnProperty.call(a2, f) && (e = W(a2[f], c), void 0 !== e && (d++ && (b2[b2.length] = ","), b2[b2.length] = W(f), b2[b2.length] = ":", b2[b2.length] = e));
          b2[b2.length] = "}";
        } else return;
      }
      return b2.join("");
  ...
  var Hd = {
  ...
  }, Kd = "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefresh".split(" "), Ld = A(K, "WI", B()), Md = function(a2, b2, c) {
    var d;
    var e = {};
    var f = d = a2;
    ...
    for (var b2 = B(), c = 0 != a2.nodeName.toLowerCase().indexOf("g:"), d = 0, e = a2.attributes.length; d < e; d++) {
      ...
      0 <= Oa.call(Nd, g) || c && 0 != g.indexOf("data-") || "null" === h || "specified" in f && !f.specified || (c && (g = g.substr(5)), b2[g.toLowerCase()] = h);
    }
    a2 = a2.style;
    ...
    ac("auth", {
      callback: function() {
        ...
        d.checkSessionState(e, function(f) {
          ...
          hc("savedUserState", g);
          (h || k) && nc(f) && !Q("disableRealtimeCallback") && d._pimf(f, true);
        });
      }
    });
    return true;
